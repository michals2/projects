...
0==a&&b&&b(!0)};
window.__onGCastApiAvailable=c;R7("//www.gstatic.com/cast/sdk/libs/sender/1.0/cast_framework.js",Q7,c)}},Tya=function(){if(T7("CriOS")){var a=window.__gCrWeb&&window.__gCrWeb.message&&window.__gCrWeb.message.invokeOnHost;
if(a){Sya();a({command:"cast.sender.init"});return}}if(!window.chrome||T7("Edge"))Q7();else if(Sya(),T7("Android")&&T7("Chrome/")&&window.navigator.presentation){a="";var b=g.Mh();55<=b?a="55":50<=b&&(a="50");R7("//www.gstatic.com/eureka/clank"+a+g.Ara,Q7)}else S7(0)},Uya=function(a){g.nG[a]&&(a=g.nG[a],(0,g.G)(a,function(a){g.lG[a]&&delete g.lG[a]}),a.length=0)},Vya=function(a){var b=g.kG();
...
g.Wc(a,"https://www.gstatic.com/cv/js/sender/v1/cast_sender.js");a=a.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+g.Za(a)},Zya=function(a,b){var c=g.Bd("SCRIPT");
...
g.Xc(c,g.ae("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js"));var d=window.document.getElementsByTagName("head")[0]||window.document.body;d.insertBefore(c,d.firstChild);return c},$ya=function(){var a=Yya(),b=window.document.getElementById(a),c=b&&g.AF(b,"loaded");
...
c(!1))},d?window.spf?window.spf.script.load("https://www.gstatic.com/cv/js/sender/v1/cast_sender.js","",void 0):$ya():Tya())):U7("Cannot initialize because not running Chrome")},e8=function(a,b){g.bG.call(this);
